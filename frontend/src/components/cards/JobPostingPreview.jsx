...
const JobPostingPreview = ({ formData, setIsPreview }) =>{
   ...
   return (
      <div className="min-h-screen bg-gradient-to-br form-slate-50 via-blue-50/30 to-purple-50/20 py-8 px-4 sm:px-6 lg:px-8">
                  ...
                  <div className="relative bg-white px-0 pb-8 mt-8 border-b border-gray-100">
                     <div className="relative z-10">
                        ...
                        <div className="flex flex-wrap gap-3 mt-6 md:mt-0">
                           ...
                           <div className="flex items-center space-x-1 px-4 py-2 bg-gray-50 bg-gray-50 text-sm text-gray-700 font-semibold rounded-full border border-gray-200">
                   ...
                   <div className="px-0 pb-8 space-y-8">
                     ...
                     <div className="relative overflow-hidden bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-100 p-6 rounded-2xl">
                        <div className="absolute top-0 right-0 w-32 h-32 bg-gradientto-br from-emerald-400/10 to-teal-400/10 rounded-full -translate-y-16 translate-x-16">
                        <div className="relative z-10">
                           <div className="flex items-center justify-between">
                        ...
                        <div className="space-y-4">
                           <h3 className="text-2xl font-bold text-gray-900 flex items-cente space-x-3">
                              ...
                              <span className="text-base md:text-lg">What We're Lokking For</span>
                           </h3>
