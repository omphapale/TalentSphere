                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <label className="block">
                      ...
                      className="block w-full text-sm text-gray-500 file:mr-4 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 transition-colors"
                      />
                    </label>
                  </div>
                </div>
