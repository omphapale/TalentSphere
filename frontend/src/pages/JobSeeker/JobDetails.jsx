          ...
          {JobDetails && (
            ...
            <div className="space-y-4">
              <h3 className="text-2xl font-bold text-gray-900 flex items-center space-x-3">
                <div className="w-1 h-8 bg-gradient-to-b from-blue-500 to-purple-500 to-purple-600 rounded-full"></div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 border border-purple-100 rounded-xl px-6">
                <div className="text-sm text-gray-700 leading-relaxed whitespace-pre-wrap">
