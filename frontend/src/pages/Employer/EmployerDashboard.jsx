...
const  EmployerDashboard =() => {
  ...
  return (
    <DashboardLayout activeMenu='employer-dashboard'>
      ...
      <div className="max-w-7xl mx-auto space-y-8 mb-96w-full max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 py-4 sm:py-6 lg:py-8 space-y-5 sm:space-y-6 lg:space-y-8">
        {/* dashboard stats */}
            ...
            {[
              {
                title : "Post New Job",
                icon : Plus ,
                color : "bg-blue-50 text-green-700",
                path : "/post-job",
              },
              {
