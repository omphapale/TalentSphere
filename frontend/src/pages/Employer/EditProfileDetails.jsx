          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div className="p-8">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    className="w-full px-3 py-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
              ...
              <div className="flex justify-end space-x-4 mt-8 pt-6 border-t">
                ...
                className="px-6 py-3 border border-gray-300 text-gray-700 rounded-lg hoverr:bg-gray-50 transition-colors flex items-center space-x-2"
                >
                  <X className="w-4 h-4"/>
                  <span>Cancel</span>
                </button>
