...
const ManageJobs = () => {
  ...
  //decide which sort icon to display bssed on current sort field and direction
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex flex-row items-center justify-between">
              ...
              <button 
              className="inline-flex items-center px-6 py-3 bg-gradient-to-r form-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-sm text-white font-semibold rounded-xl shadow-lg shadow-blue-500/25 hover:shadow-xl hover:shadow-blue-500/30 transition-all duration-300 tranform hover:-translate-y-0.5 whitespace-nowrap"
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-white/20 overflow-hidden">
                {filteredAndSortJobs.length ===  0 && !isLoading ? (
                  <div className="text-center py-12">
                    <div className="w-24 h-24 mx-auto bg-gray-100 rounded-full flex items-center justify-center mb-4">
                      <Search className="w-10 h-10 text-ray-400"/>
                    </div>
                  ...
                  <div className="w-[75vw] md:w-full overflow-x-auto scrollbar-thin scroller-thumb-gray-300 scrollba-track-gray-100">
                    <table className="min-w-full divide-y divide-gray-200">
                      ...
                      <tbody className="bg-white divide-y divide-gray-200">
                          ...
                          : paginatedJobs.map((job) => (
                            ...
                            >
                              <td className="px-6 py-5 whitespce-nowrap min-w-[200px] sm:min-w-0">
                                <div>
                              ...
                              <td className="px-6 py-5 whitespce-nowrap min-w-[120px] sm:min-w-0">
                                <span
                              ...
                              <td className="px-6 py-5 whitespce-nowrap min-w-[130px] sm:min-w-0">
                                <button 
                              ...
                              <td className="px-6 py-5 whitespce-nowrap min-w-[180px] sm:min-w-0">
                                <div className="flex space-x-2">
                                  <button 
                ...
                <div className="mt-6 flex items-center justify-between">
                  <div className="flex-1 flex justify-between sm:hidden">
                    ...
                    className="ml-3 relative flex items-center px-4 py-2 border border-gray-300 teext-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      Next
                    </button>
                  </div>
                        ...
                        <nav className="relative z-0 inline-flex rounded-md shadow-sm -space-x-px">
                          ...
                          {Array.from({ length: totalPages}, (_, i) => i + 1).map(
                            (page) =>(
                              ...
                              className={`realtive inline-flex items-center px-4 border text-sm font-medium${
                                currentPage === page
