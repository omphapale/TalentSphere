  ...
  const handleSubmit = async (e) => {
    ...
    try{
      ...
      if (response.status === 200 || response.status === 201){
        toast.success(
          jobId ? "Job Updatec Successfully!" : "Job Posted Successfully!"
        );
        setFormData({
          jobTitle: "",
          location: "",
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white shadow-xl rounded-2xl p-6">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="text-xl font-bold bg-gradient-to-br from-gray-900 to-gray-600 bg-clip-text text-transparent">Post a New Job</h2>
          ...
          <div className="space-y-6">
            ...
            helperText="Include key responsibilities, day-to-day tasks, and what makes this role exiciting"
            required
            />
            ...
            helperText="Include required skills, experience level, education, and any prefered qualifications "
            required
            />
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-3 gap-3">
                <div className="relative">
                  ...
                  className="w-full pl-10 py-2.5 border border-gray-300 rounded-lg text-base focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-20 focus:border-blue-500 transition-colors duration-200"
                  />
                </div>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none z-10">
            ...
            <div className="pt-2">
              ...
              className="w-full flex items-center justify-center px-4 py-3 border border-transparent text-base rounded-lg text-white bg-blue-600 hover:outline-none focus:ring-offset-2 focus:ring-blue-500 disabled:bg-gray-400 disabled:cursor-not-allowed outline-none transition-colors duration-200"
              >
                {isSubmitting ? (
                  <>
